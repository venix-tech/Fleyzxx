...
<head>
  ...
  <title>ResidentApps Panel</title>
  ...
  <div class="sidebar" id="sidebar">
    <div class="sidebar-header">
      ...
      <div class="logo-container">
        ...
        <img src="https://c.top4top.io/p_3623zhbjh0.jpg" class="logo" alt="Fleyzxx.iqc">
      </div>
      <div class="app-title">Fleyzxx</div>
      <div class="access-info"><b><i>Quote Generator Mode</i></b></div>
    </div>
    
    <ul class="nav-menu">
      <li class="nav-item"><a href="https://whatsapp.com/channel/0029VbBT4VMLY6dDiHRuiq19" class="nav-link"><i class="fab fa-whatsapp"></i>WhatsApp</a></li>
    </ul>
  </div>
  ...
  <div class="main-content">
    ...
    <div class="server-banner">
      <video class="banner-video" autoplay muted loop playsinline>
        <source src="https://files.catbox.moe/u3xd7t.mp4" type="video/mp4">
        Your browser does not support the video tag.
      </video>
      <div class="banner-content">
        <div class="banner-title">Fleyxx</div>
